    ...
    <div style={{ background: 'var(--primary)', color: 'white', minHeight: '100vh' }}>
      <nav className="navbar">
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <a href="#" onClick={() => { setActiveTab('Home'); setSelectedBlog(null); setSelectedLocation(null); }} className="nav-brand">
            SarkariExam<span>All</span>
          </a>
          <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
            <a href="#hub" onClick={() => { setActiveTab('Home'); setSelectedBlog(null); setSelectedLocation(null); }} style={{ color: 'white', textDecoration: 'none', fontWeight: 600, fontSize: '0.95rem' }}>Exam Hub</a>
            <a href="#" onClick={() => { setActiveTab('Blog'); setSelectedBlog(null); setSelectedLocation(null); }} style={{ color: activeTab === 'Blog' ? 'var(--secondary)' : 'white', textDecoration: 'none', fontWeight: 600, fontSize: '0.95rem' }}>Blog</a>
            <a href="#" onClick={() => { setActiveTab('Locations'); setSelectedBlog(null); setSelectedLocation(null); }} style={{ color: activeTab === 'Locations' ? 'var(--secondary)' : 'white', textDecoration: 'none', fontWeight: 600, fontSize: '0.95rem' }}>Top Cities</a>
            <a href="#" onClick={() => setActiveTab('Contact')} className="btn btn-secondary" style={{ padding: '0.5rem 1rem', fontSize: '0.85rem' }}>Get In Touch</a>
          </div>
        </div>
      </nav>
      ...
      {activeTab === 'Detail' && selectedBlog && <ArticleDetail blog={selectedBlog} onBack={() => setActiveTab('Blog')} />}
      {activeTab === 'About' && <AboutPage onBack={() => setActiveTab('Home')} />}
      {activeTab === 'Success' && <SuccessStoriesPage onBack={() => setActiveTab('Home')} />}
      {activeTab === 'Counseling' && <CareerCounselingPage onBack={() => setActiveTab('Home')} />}
      {activeTab === 'Partner' && <PartnerPage onBack={() => setActiveTab('Home')} />}
        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                {locations.slice(0, 6).map(loc => (
                  <li key={loc.id}><a href="#" onClick={() => { setSelectedLocation(loc); setActiveTab('Location'); }}>{loc.name} Exams</a></li>
                ))}
              </ul>
            </div>
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="#" onClick={() => setActiveTab('About')}>About SarkariExamAll</a></li>
                <li><a href="#" onClick={() => setActiveTab('About')}>Our Mission</a></li>
                <li><a href="#" onClick={() => setActiveTab('Success')}>Success Stories</a></li>
                <li><a href="#" onClick={() => setActiveTab('Contact')}>Contact Us</a></li>
                <li><a href="#" onClick={() => setActiveTab('Contact')}>Advertise With Us</a></li>
                <li><a href="#" onClick={() => setActiveTab('Partner')}>Partner With Us</a></li>
              </ul>
            </div>
