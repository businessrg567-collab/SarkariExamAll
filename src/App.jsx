...
const App = () => {
  ...
  const renderHome = () => (
    <>
        ...
        <div className="container">
          <div className="glass-card reveal" style={{ 
            ...
            <div style={{ maxWidth: '820px', margin: '0 auto', textAlign: 'center' }}>
              ...
              {/* Buttons */}
              <div className="founder-social-btns" style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
                <a 
                ...
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9" fill="white"/><circle cx="4" cy="4" r="2" fill="white"/></svg>
                  LinkedIn
                </a>
                <a 
                  ...
                  style={{ 
                    ...
                    color: 'white', textDecoration: 'none', fontWeight: 700, fontSize: '0.95rem',
                    boxShadow: '0 4px 15px rgba(221,42,123,0.4)'
                  }}
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                  Instagram
                </a>
                <a 
      ...
      {/* Office Location Section - Before FAQs */}
      <section style={{ padding: 'var(--section-padding) 0', background: 'rgba(255,255,255,0.02)' }}>
        <div className="container">
