...
import {
  ...
  TrendingUp, Users, Award, Mail, Instagram, Globe, Star, Target
} from 'lucide-react';
        ...
        <div className="glass-card" style={{
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="https://www.instagram.com/radhikata_/" target="_blank" rel="noopener noreferrer"
              style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', padding: '0.75rem 1.5rem', borderRadius: '30px', background: 'linear-gradient(135deg, #E1306C, #833AB4)', color: 'white', textDecoration: 'none', fontWeight: 700, fontSize: '0.95rem' }}>
              <Instagram size={16} /> @radhikata_
            </a>
            <a href="https://www.linkedin.com/in/radhika-gupta-3a2555391" target="_blank" rel="noopener noreferrer"
              style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', padding: '0.75rem 1.5rem', borderRadius: '30px', background: 'linear-gradient(135deg, #0077B5, #005885)', color: 'white', textDecoration: 'none', fontWeight: 700, fontSize: '0.95rem' }}>
